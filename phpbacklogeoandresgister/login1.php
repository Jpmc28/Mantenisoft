...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Consulta para obtener la contraseña cifrada y el estado del usuario
    $sql = "SELECT id_usuario, nombre, Cedula, tipo_usuario, correo, contraseña, Rol, estado FROM usuarios WHERE correo = ?";
