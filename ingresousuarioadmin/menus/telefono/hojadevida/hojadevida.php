...
$sql_mantenimientos = "SELECT m.id_mantenimiento_telefono, m.fecha_cambio, u.nombre AS nombre_usuario, m.tipo_cambio
    ...
    <div class="detalle-equipo">
        ...
        <h3>Historial de arreglos</h3>
            <div class="historial-mantenimiento">
                ...
                <?php else: ?>
                    <p>No hay cambios registrados para este telefono.</p>
                <?php endif; ?>
            </div>
        <!-- Botones -->
        <div class="botones">
            <form action="agregar_mantenimiento.php" method="GET">
                <input type="hidden" name="id_activo" value="<?php echo $id_activo; ?>">
                <button type="submit" class="btn mantenimiento">Arreglos</button>
            </form>
        </div>
    </div>
</div>
